...
export default function Test() {
    ...
    const handleAnswer = (questionId, optionId, isCorrect) => {
        ...
        setPlayerStats((prev) => {
            ...
            const streakBonus =
                newStreak >= 3 ? Math.floor(newStreak / 3) * 50 : 0;
            const questionPoints = questions.find(
                (q) => q.id === questionId
            ).points;
            ...
            return {
                ...
                streak: newStreak,
                level: Math.floor(
                    (prev.points + (isCorrect ? questionPoints : 0)) / 200 + 1
                ),
            };
        });
    };
                    ...
                    <div className="flex items-center justify-evenly space-x-4 bg-white p-3 rounded-lg shadow-sm">
                        ...
                        <div>
                            <div className="flex space-x-1">
                                {[...Array(playerStats.powerUps)].map(
                                    (_, i) => (
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold">
                                    {testStats.totalPoints}
                                </p>
                            </div>
                            <div>
                                <p className="text-sm text-gray-500">Topics</p>
                                <p className="text-lg font-semibold">
                                    {testStats.coverage.join(', ')}
                                </p>
                            </div>
                            <div>
                                <p className="text-sm text-gray-500">
                ...
                <div className="fixed z-[10] bottom-4 right-4 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded-lg shadow-lg max-w-xs animate-bounce">
                    <div className="flex items-start">
                        ...
                        <div>
                            ...
                            <p className="text-sm">
                                3-in-a-row: Answered 3 questions correctly
                                consecutively
                            </p>
                        </div>
                    </div>
